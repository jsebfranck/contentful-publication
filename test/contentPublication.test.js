...
describe('Content publication', function () {
  ...
  var expectToGetDestinationSpace = function() {
    nock('https://api.contentful.com:443')
      .get('/spaces/SPACE_DEST?access_token=CONTENT_MGT_TOKEN')
  ...
  var expectToGetSourceItemsWithExistingSyncAndPageUrl = function(items) {
    nock('https://cdn.contentful.com:443')
      .get('/spaces/SPACE_SRC/sync?sync_token=NEXT-SYNC-TOKEN&access_token=SRC_DELIVERY_TOKEN')
      .reply(200, {"sys": {"type": "Array"}, "items": items,
  ...
  describe('for all contents', function() {
    ...
    it('should process contents with two sync requests', function (done) {
      ...
      nock('https://api.contentful.com:443')
        .get('/spaces/SPACE_DEST/entries/2XS1ZMB87KSWAI4o6aOw0G?access_token=CONTENT_MGT_TOKEN')
      ...
      nock('https://api.contentful.com:443')
        .put('/spaces/SPACE_DEST/entries/2XS1ZMB87KSWAI4o6aOw0G?access_token=CONTENT_MGT_TOKEN', {"fields": {"contentfulTitle": {"en-US": "1a"}, "message": {"en-US": "2"}, "number": {"en-US": 3}, "text": {"en-US": "4"}}})
      ...
      nock('https://api.contentful.com:443')
        .put('/spaces/SPACE_DEST/entries/2XS1ZMB87KSWAI4o6aOw0G/published?access_token=CONTENT_MGT_TOKEN')
      ...
      nock('https://api.contentful.com:443')
        .put('/spaces/SPACE_DEST/entries/2XS1ZMB87KSWAI4o6aOw0G?access_token=CONTENT_MGT_TOKEN', {"fields": {"contentfulTitle": {"en-US": "1b"}, "message": {"en-US": "2"}, "number": {"en-US": 3}, "text": {"en-US": "4"}}})
    ...
    it('should process one entry and one asset', function (done) {
      ...
      nock('https://api.contentful.com:443')
        .put('/spaces/SPACE_DEST/entries/2XS1ZMB87KSWAI4o6aOw0G?access_token=CONTENT_MGT_TOKEN', {"fields": {"contentfulTitle": {"en-US": "1"}, "message": {"en-US": "2"}, "number": {"en-US": 3}, "text": {"en-US": "4"}}})
      ...
      nock('https://api.contentful.com:443')
        .get('/spaces/SPACE_DEST/assets/9WwNj5BjrOwawsOuAIIce?access_token=CONTENT_MGT_TOKEN')
      ...
      nock('https://api.contentful.com:443')
        .put('/spaces/SPACE_DEST/assets/9WwNj5BjrOwawsOuAIIce?access_token=CONTENT_MGT_TOKEN', {"fields": {"file": {"en-US": {"fileName": "add_directory_icon.svg", "contentType": "image/svg+xml", "details": {"size": 984}, "url": "//assets.contentful.com/SPACE_SRC/9WwNj5BjrOwawsOuAIIce/1365a0d50dbb810b731a815c9a579ad0/add_directory_icon.svg"}}, "title": {"en-US": "add directory icon"}}, "sys": {"space": {"sys": {"type": "Link", "linkType": "Space", "id": "SPACE_SRC"}}, "type": "Asset", "id": "9WwNj5BjrOwawsOuAIIce", "revision": 1, "createdAt": "2014-12-04T16:46:25.594Z", "updatedAt": "2014-12-04T16:46:25.594Z"}})
      ...
      nock('https://api.contentful.com:443')
        .put('/spaces/SPACE_DEST/assets/9WwNj5BjrOwawsOuAIIce/published?access_token=CONTENT_MGT_TOKEN')
  ...
  describe('for entries', function() {
    ...
    it('should update an entry on the unsynchronized space', function (done) {
      ...
      nock('https://api.contentful.com:443')
        .put('/spaces/SPACE_DEST/entries/2XS1ZMB87KSWAI4o6aOw0G?access_token=CONTENT_MGT_TOKEN', {"fields": {"contentfulTitle": {"en-US": "12"}, "message": {"en-US": "2"}, "number": {"en-US": 3}, "text": {"en-US": "4"}}})
    ...
    it('should remove an entry on a synchronized space', function (done) {
      ...
      nock('https://api.contentful.com:443')
        .delete('/spaces/SPACE_DEST/entries/26GRGDvgvyQ0cswwMscCIc/published?access_token=CONTENT_MGT_TOKEN')
      ...
      nock('https://api.contentful.com:443')
        .delete('/spaces/SPACE_DEST/entries/26GRGDvgvyQ0cswwMscCIc?access_token=CONTENT_MGT_TOKEN')
        .reply(204, "");
  ...
  describe('for assets', function() {
    ...
    it('should update an asset on a unsynchronized space', function (done) {
      ...
      nock('https://api.contentful.com:443')
        .get('/spaces/SPACE_DEST/assets/1P3ydRWdSwcmEIQkeGySAo?access_token=CONTENT_MGT_TOKEN')
      ...
      nock('https://api.contentful.com:443')
        .put('/spaces/SPACE_DEST/assets/1P3ydRWdSwcmEIQkeGySAo/published?access_token=CONTENT_MGT_TOKEN')
    ...
    it('should remove an asset on a synchronized space', function (done) {
      ...
      nock('https://api.contentful.com:443')
        .delete('/spaces/SPACE_DEST/assets/6HTjuv5pqogeMcoysSGuqk/published?access_token=CONTENT_MGT_TOKEN')
      ...
      nock('https://api.contentful.com:443')
        .delete('/spaces/SPACE_DEST/assets/6HTjuv5pqogeMcoysSGuqk?access_token=CONTENT_MGT_TOKEN')
        .reply(204, "");
